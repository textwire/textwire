...
- ♻️ Refactored internal logic for evaluator. Separated literal values from non-literal. Closes [#90](https://github.com/textwire/textwire/issues/90).
...
## [Release Notes V3](CHANGELOG-V3.md)
