...
func errorPage(err *fail.Error) string {
	msg := "Sorry! We’re having some trouble right now. Please check back shortly"

	if userConfig.DebugMode {
		msg = err.Meta() + "<br><br>" + err.Message()
	}
