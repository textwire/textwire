...
func TestEvalBooleanExp(t *testing.T) {
	cases := []struct {
		...
		{250, "{{ true && false || false }}", "0"},
		{260, "{{ false && (false || true) }}", "0"},
		{270, "{{ 3 && 0 }}", "0"},
		{280, "{{ [] && [] }}", "0"},
		{290, "{{ {} && {} }}", "0"},
		{300, "{{ 0.2 && 2.3 }}", "1"},
...
func TestEvalComments(t *testing.T) {
	cases := []struct {
		...
		{130, "{{-- @each(u in users){{ u }}@end --}}", ""},
		{140, "{{-- @if(true)Hello@end --}}", ""},
		{150, "{{-- @for(i=0;i<10;i++){{i}}@end --}}", ""},
...
func TestTypeMismatchError(t *testing.T) {
	cases := []struct {
		...
		{20, "{{ 3 + 2.0 }}", object.INT_OBJ, "+", object.FLOAT_OBJ},
		{30, "{{ 2.0 + 3 }}", object.FLOAT_OBJ, "+", object.INT_OBJ},
		{40, "{{ 5 - 1.5 }}", object.INT_OBJ, "-", object.FLOAT_OBJ},
		{50, "{{ 4.5 - 2 }}", object.FLOAT_OBJ, "-", object.INT_OBJ},
		{60, "{{ 3 * 2.5 }}", object.INT_OBJ, "*", object.FLOAT_OBJ},
		{70, "{{ 2.5 * 4 }}", object.FLOAT_OBJ, "*", object.INT_OBJ},
		{80, "{{ 10 / 2.5 }}", object.INT_OBJ, "/", object.FLOAT_OBJ},
		{90, "{{ 7.5 / 3 }}", object.FLOAT_OBJ, "/", object.INT_OBJ},
		// Arithmetic with strings
		{140, "{{ 5 * 'x' }}", object.INT_OBJ, "*", object.STR_OBJ},
		{150, "{{ 'x' * 3 }}", object.STR_OBJ, "*", object.INT_OBJ},
		{160, "{{ 'x' / 2 }}", object.STR_OBJ, "/", object.INT_OBJ},
		{170, "{{ 2 / 'x' }}", object.INT_OBJ, "/", object.STR_OBJ},
		{180, "{{ 'a' - 2 }}", object.STR_OBJ, "-", object.INT_OBJ},
		{190, "{{ 'a' / 3.0 }}", object.STR_OBJ, "/", object.FLOAT_OBJ},
		// Arithmetic with booleans
		{200, "{{ true + 5 }}", object.BOOL_OBJ, "+", object.INT_OBJ},
		{210, "{{ 5 - true }}", object.INT_OBJ, "-", object.BOOL_OBJ},
		{220, "{{ false - 2.0 }}", object.BOOL_OBJ, "-", object.FLOAT_OBJ},
		{230, "{{ 2.0 + true }}", object.FLOAT_OBJ, "+", object.BOOL_OBJ},
		{240, "{{ true * 1 }}", object.BOOL_OBJ, "*", object.INT_OBJ},
		{250, "{{ true / 2 }}", object.BOOL_OBJ, "/", object.INT_OBJ},
		// Boolean with strings
		{260, "{{ true + 'str' }}", object.BOOL_OBJ, "+", object.STR_OBJ},
		{270, "{{ 'str' - false }}", object.STR_OBJ, "-", object.BOOL_OBJ},
		// Modulo operator
		{400, "{{ 5 % 2.0 }}", object.INT_OBJ, "%", object.FLOAT_OBJ},
		{410, "{{ 5.0 % 2 }}", object.FLOAT_OBJ, "%", object.INT_OBJ},
		{420, "{{ 'a' % 2 }}", object.STR_OBJ, "%", object.INT_OBJ},
		{430, "{{ true % 2 }}", object.BOOL_OBJ, "%", object.INT_OBJ},
		// Mixed type comparisons with == and !=
		{490, "{{ 1 == '1' }}", object.INT_OBJ, "==", object.STR_OBJ},
		{500, "{{ '1' == 1 }}", object.STR_OBJ, "==", object.INT_OBJ},
		{510, "{{ true == 1 }}", object.BOOL_OBJ, "==", object.INT_OBJ},
		{520, "{{ 1 == true }}", object.INT_OBJ, "==", object.BOOL_OBJ},
		{530, "{{ false == 0 }}", object.BOOL_OBJ, "==", object.INT_OBJ},
		{540, "{{ 0 == false }}", object.INT_OBJ, "==", object.BOOL_OBJ},
		{550, "{{ 1.0 == 1 }}", object.FLOAT_OBJ, "==", object.INT_OBJ},
		{560, "{{ 1 == 1.0 }}", object.INT_OBJ, "==", object.FLOAT_OBJ},
	}
...
func TestNotSupportedTypeError(t *testing.T) {
	cases := []struct {
		...
		{300, "{{ [] + {} }}", "+", object.ARR_OBJ},
		{310, "{{ {} - [] }}", "-", object.OBJ_OBJ},
		{320, "{{ [] * 1 }}", "*", object.ARR_OBJ},
		{330, "{{ {} / 1 }}", "/", object.OBJ_OBJ},
		// Int/Object operations
		{340, "{{ 3 + {} }}", "+", object.OBJ_OBJ},
		{350, "{{ {} - 3 }}", "-", object.OBJ_OBJ},
		{360, "{{ 5 * {} }}", "*", object.OBJ_OBJ},
		// Array with arithmetic
		{370, "{{ [] + 5 }}", "+", object.ARR_OBJ},
		{380, "{{ 10 - [] }}", "-", object.ARR_OBJ},
		{390, "{{ [] * 3 }}", "*", object.ARR_OBJ},
		// Float with arrays/objects
		{470, "{{ 3.14 + [] }}", "+", object.ARR_OBJ},
		{480, "{{ {} / 2.5 }}", "/", object.FLOAT_OBJ},
		// String with arrays/objects
		{100, "{{ 'x' - [] }}", "-", object.ARR_OBJ},
		{110, "{{ {} - 'x' }}", "-", object.STR_OBJ},
		{120, "{{ 'str' + [] }}", "+", object.ARR_OBJ},
		{130, "{{ {} + 'str' }}", "+", object.STR_OBJ},
		// Mixed type comparisons with == and !=
		{570, "{{ [] == [] }}", "==", object.ARR_OBJ},
		{580, "{{ [1, 2] == [1, 2] }}", "==", object.ARR_OBJ},
		{590, "{{ [1] == [2] }}", "==", object.ARR_OBJ},
		{600, "{{ [] != [] }}", "!=", object.ARR_OBJ},
		{610, "{{ [1] != [1] }}", "!=", object.ARR_OBJ},
		{620, "{{ {} == {} }}", "==", object.OBJ_OBJ},
		{630, "{{ {a: 1} == {a: 1} }}", "==", object.OBJ_OBJ},
		{640, "{{ {a: 1} == {a: 2} }}", "==", object.OBJ_OBJ},
		{650, "{{ {} != {} }}", "!=", object.OBJ_OBJ},
		{660, "{{ {a: 1} != {a: 1} }}", "!=", object.OBJ_OBJ},
	}
