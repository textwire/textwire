...
func TestEvalFormatDateGlobalFunc(t *testing.T) {
	cases := []struct {
		...
		{20, "{{ formatDate('2027-12-13 10:00:09', '2006-01-02 15:04:05') }}", "2027-12-13 10:00:09"},
		...
		{120, "{{ formatDate('2026-01-01 00:00:00', '2006-01-02 15:04:05') }}", "2026-01-01 00:00:00"},
		...
		{150, "{{ formatDate('2026-12-31 23:59:59', '2006-01-02 15:04:05') }}", "2026-12-31 23:59:59"},
		...
		{190, "{{ formatDate('2024-02-29 12:30:45', '2006-01-02 15:04:05') }}", "2024-02-29 12:30:45"},
		...
		{220, "{{ formatDate('2026-03-05 01:02:03', '2006-01-02 15:04:05') }}", "2026-03-05 01:02:03"},
		// Early morning times
		{230, "{{ formatDate('2026-06-15 01:23:45', '15:04:05') }}", "01:23:45"},
		{240, "{{ formatDate('2026-06-15 02:00:00', '2006-01-02 15:04:05') }}", "2026-06-15 02:00:00"},
		// Afternoon/PM times
		{250, "{{ formatDate('2026-08-20 13:45:30', '15:04:05') }}", "13:45:30"},
		{260, "{{ formatDate('2026-08-20 15:30:00', '2006-01-02 15:04:05') }}", "2026-08-20 15:30:00"},
